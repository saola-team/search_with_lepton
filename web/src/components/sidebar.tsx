...
const Sidebar = () => {
  ...
  return (
    !isShowSidebar && (
      <section
        className="flex h-screen w-[220px] flex-col justify-between border-r border-gray-200 bg-white pt-8 sm:pb-4 xl:pb-6 text-black max-md:hidden 2xl:w-[220px] transition-all duration-300 overflow-hidden"
        style={{
          width: isSidebarExpanded ? "220px" : "40px",
        }}
      >
        {!isSidebarExpanded ? (
